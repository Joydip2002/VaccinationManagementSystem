...
<body>
     <h3>Welcome! <?php echo $_SESSION['HosUsername'];  ?></h3> 

     <div id="container">
          <div class="item t1">
            <div id="adminimage"></div>
            <h1>Hospital Admin</h1>
            <h2><?php echo $_SESSION['HosUsername']; ?></h2>
            <h4>Email : <?php echo $_SESSION['hospitalEmail']; ?></h4>
            <a href="Logout.php">Logout</a>
          </div>
          <div class="item t2">
            <div class="opimage"></div>
            <a href="CurrentVaccineStatus.php">Current Vaccine Status</a>
          </div>
          <div class="item t3">
            <div class="opimage"></div>
            <a href="VaccineStatusUpdate.php">Patient Update</a></div>
          <div class="item t4">
            <div class="opimage"></div>
            <a href="UpdateVaccineDetails.php">Update Vaccine Status</a>
          </div>
          <div class="item t5">
            <div class="opimage"></div>
